...
En criptografía se habla de un algoritmo de cifrado asimétrico cuando se tienen dos claves; Una privada y otra pública.
...
Es el diseño que adoptan las comunicaciones web donde siempre hay un cliente (Ej. Navegador) y servidor (la máquina que contiene la información a la que queremos acceder).
...
Esta calidad aumentará cuanto más fiables y limpios sean los datos.
Se pueden transformar los datos para tratar de aumentar la calidad.

## Cartograma

Un Cartograma es un tipo de gráfica para visualizar datos geográficos. Es decir, se utilizan para representar datos con información en diferentes puntos o zonas en un mapa.
...
## FTP
FTP es un protocolo de comunicación entre dos ordenadores muy comunmente utilizado en el intercambio de ficheros.
...
Es un tipo de gráfico que muestra los diferentes valores de diferentes categorias de una dimensión de los datos.
Es muy útil porque se pueden comparar los resultados de las distintas categorias de forma muy intuitiva y visual.

## Gráfico de caja y bigotes

Este tipo de gráfica se utiliza para representar la dispersión de los valores de unos datos.
Los bigotes alcanzarían los valores extremos, es decir, el mínimo y el máximo. Y la caja abarca desde el primer cuartil hasta el tercero.
También, la caja tiene una línea cruzandola que sería el lugar de la mediana.
...
El historiograma es un gráfico de barras que en vez de presentar el valor de diferentes categorías lo que representa es la frecuencia con la que aparece
un cierto dato en el set de datos.
...
Lenguaje de programación orientado a objetos. Muy popular sobretodo para el desarrollo de aplicaciones en Android.
...
Son los lenguajes que son fácilmente interpretados por humanos.
...
Es el protocolo de comunicación que permite conectarse a un dispositivo a la red.

## Puertas lógicas

Pueden ser: AND, OR, XOR, NOT, NAN,  NOR  y XNOR y cada una tiene definido un resultado para cada par de estados binarios.

## Python

Lenguaje interpretado. Muy utilizado para procesamiento de datos e IA.
...
Es un elemento electrónico que funciona como switch. Tiene dos estados: dejar pasar la corriente/ no dejar pasar la corriente. Con ellos se pueden construir todas las puertas lógicas.
